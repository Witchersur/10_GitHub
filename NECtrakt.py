        ...
        for y in sc2:
            for ln1 in nec1:  # основные тракты
                if y in ln1:
                    ...
                    # if mux1[0] == mux2[0] or mux1[2] == mux2[2]:  # муксы доп и осн тракта в одном месте
                    #     if mux1[0] == mux2[0] and mux1[1] == '':  # если у мукс А нет порта, то
                    #         mux1[1] = mux2[1]  # порт мукса А осн равен порту мукса А доп тракта
                    #     elif mux1[2] == mux2[2] and mux1[3] == '':  # если у мукс В нет порта, то
                    #         mux1[3] = mux2[3]  # порт мукса В осн равен порту мукса В доп тракта
